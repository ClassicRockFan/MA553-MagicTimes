...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', type=str, default="s3://sagemaker-park-data/disney-data/disney_train.pkl")
    parser.add_argument('--test', type=str, default="s3://sagemaker-park-data/disney-data/disney_test.pkl")
    ...
    try:
        s3.Bucket("sagemaker-park-data").download_file("disney-data/disney_train.pkl", "disney_train.pkl")
        s3.Bucket("sagemaker-park-data").download_file("disney-data/disney_test.pkl", "disney_test.pkl")
    ...
    #Reading in data
    ############
    with open("disney_train.pkl",'rb') as f:
    ...
    model.save(os.path.join(sm_model_dir, "disney"), 'disney_model.h5')